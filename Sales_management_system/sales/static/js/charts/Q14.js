export function render(data) {
    ...
    svg.append("text")
        ...
        .text("Doanh số theo phân khúc khách hàng");
    
    // Tạo thang đo cho trục Y (chỉ hiển thị mã phân khúc khách hàng)
    ...
    // Sửa đổi thang màu để sử dụng d3.schemeTableau10 giống Q2
    ...
    svg.selectAll(".bar")
        ...
        .on("mouseover", function(event, d) {
            ...
            tooltip.html(`<strong>Phân khúc: [${d.segment_code}] ${d.segment_name}</strong><br>
                            Doanh số: ${d.total_revenue.toLocaleString()} VNĐ`)
